...
---
## Background - Location
Located on the west coast of India. Financial centre, the largest city in India.
...
Industry, vehicles and buildings pollutants affected in Mumbai, which has a population of 12 million. The Swiss IQAir Group ranks Mumbai as the sixth most polluted city in the world.
...
.panel[.panel-name[**Transport and large-scale urban development**]
* **80%** of Mumbai's carbon emissions come from road transport.

* Paved and unpaved roads **Dust**.

* Dust pollution from subway construction accounts for **3%** of the total pollution.
...
| **Environmental**| - Mumbai, with a population of over 20 million, shrouded in heavy smog for consecutive days (2021)<br>- Over 90% live in areas where air quality is below WHO standards (2022)<br>- Multidimensional pollution affecting ecology, water sources, etc.<br>- High pollution causes losses of about $150 billion annually to Indian businesses (2021) |
...
- Users can choose to view different air quality indicators through different layers on the map.

- Technical methods include using Google Maps API, open source library (Leaflet, ECharts).
...
knitr::include_graphics("Figure/Figure Part 3/img/future_work.png")
```
